  ...
  return (
    <InView>
      {({ inView, ref }) => (
        ...
        >
          <div
            className="w-4/5 mx-auto my-36 flex text-white"
            id="collecttokens"
          >
            <div className="w-7/12 flex mr-10 flex-col justify-center">
              <p className="float-left text-5xl font-semibold leading-tight">
                GET <span className=" text-purple-800">EXCLUSIVE</span> GAMES{" "}
              </p>
              <p className="float-left text-5xl font-semibold leading-tight">
                WITH <span className=" text-purple-800">GAMERLY</span> TOKENS IN{" "}
